...
describe('readSessionData', () => {
  it('returns parsed data when file exists', () => {
    const expected: SessionData = { tokens: 10000, cap: 200000, percent: 5, systemTokens: 0, convoTokens: 0, rewindSavings: 0, rewindSavingsPct: 0, outputTokens: 0, messageCount: 0 };
  ...
  it('returns fallback when file read throws', () => {
    ...
    const result = readSessionData();
    expect(result).toEqual({ tokens: 0, cap: 200_000, percent: 0, systemTokens: 0, convoTokens: 0, rewindSavings: 0, rewindSavingsPct: 0, outputTokens: 0, messageCount: 0 });
  });
});
...
describe('watchSessionFile', () => {
  it('calls onChange when file change event fires', () => {
    ...
    const expected: SessionData = { tokens: 5000, cap: 200000, percent: 3, systemTokens: 0, convoTokens: 0, rewindSavings: 0, rewindSavingsPct: 0, outputTokens: 0, messageCount: 0 };
