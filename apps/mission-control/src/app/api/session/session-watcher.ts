...
const FALLBACK: SessionData = { tokens: 0, cap: 200_000, percent: 0, systemTokens: 0, convoTokens: 0, rewindSavings: 0, rewindSavingsPct: 0, outputTokens: 0, messageCount: 0 };
