# Plan: Add redirect to route traffic to fleet-sync function

## TYPE
FEATURE

## Task
The Next.js plugin's catch-all rewrite intercepts /.netlify/functions/fleet-sync before our function runs. Add an explicit redirect with force=true so user-defined redirects take priority.

## Files to Change
- `netlify.toml` — add [[redirects]] rule
