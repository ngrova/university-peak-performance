...
### 1. SANDI METZ RULES (hard limits) [RUNTIME-ONLY]
...
### 2. TYPESCRIPT STRICT [RUNTIME-ONLY]
...
### 3. FUNCTION DOCUMENTATION [RUNTIME-ONLY]
...
### 4. FILE NAMING & HEADERS [RUNTIME-ONLY]
...
### 5. FORBIDDEN IN PRODUCTION CODE [RUNTIME-ONLY]
...
### 6. SUPABASE SERVER CLIENT PATTERN [RUNTIME-ONLY]
...
### 7. SERVER ACTION STRUCTURE [RUNTIME-ONLY]
...
### 8. SORT ORDER PATTERN [RUNTIME-ONLY]
...
### 9. COMPONENT & DATA PATTERNS [RUNTIME-ONLY]
...
### 10. DESIGN REGISTRY [RUNTIME-ONLY]
