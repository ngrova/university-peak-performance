...
### 1. SUPABASE QUERY SAFETY [RUNTIME-ONLY]
...
### 3. FORBIDDEN PATTERNS [UNIVERSAL]
...
### 4. ENVIRONMENT VARIABLE SAFETY [UNIVERSAL]
...
### 5. VALUE-TO-COLUMN COMPATIBILITY [RUNTIME-ONLY]
...
### 6. SILENT FAILURE DETECTION [RUNTIME-ONLY]
...
### 7. DUPLICATE PREVENTION & DATA PRESERVATION [RUNTIME-ONLY]
...
### 9. SERVER ACTION EXPOSURE [RUNTIME-ONLY]
...
### 10. SERVER-SIDE VALIDATION [RUNTIME-ONLY]
...
### 11. SECURITY PATTERN CONSISTENCY [RUNTIME-ONLY]
...
### 12. OUTPUT INJECTION & DATA LEAKAGE [RUNTIME-ONLY]
