...
### 5. REGISTRY STALENESS
- Does the diff modify or add a file in `src/components/` (or the project's component directory) without including changes to `docs/DESIGN-REGISTRY.md`, `docs/DESIGN-TOKENS.md`, or `docs/CODE-PATTERNS.md`? (If so, the registry may be going stale.)
