...
### 1. SUPABASE CLIENT RULES [RUNTIME-ONLY]
...
### 2. TANSTACK QUERY + SERVER ACTION RULES [RUNTIME-ONLY]
...
### 3. NETLIFY SERVERLESS RULES [RUNTIME-ONLY]
...
### 4. NEXT.JS APP ROUTER RULES [RUNTIME-ONLY]
...
### 6. MIGRATION SAFETY [RUNTIME-ONLY]
